...
playlist_urls = [
    "https://tfms.xyz/dadraw.m3u8",
    "https://raw.githubusercontent.com/Drewski2423/DrewLive/refs/heads/main/DaddyLiveRAW.m3u8",
   ]

UDPTV_URL = "https://raw.githubusercontent.com/nightah/daddylive/refs/heads/main/daddylive-channels-tivimate.m3u8"
EPG_URL = "https://raw.githubusercontent.com/nightah/daddylive/refs/heads/main/epgs/daddylive-channels-epg.xml"
OUTPUT_FILE = "DaddyLive-raw.m3u"
REMOVED_FILE = "Removed.m3u"
...
def is_nsfw(extinf, headers, url):
    nsfw_keywords = ['|', 'Prima', 'afrique', 'eplayer', 'SPAIN', 'ITALY', 'DENMARK', 'GERMANY', 'PAKISTAN', 'PORTUGAL', 'UNITED ARAB EMIRATES', 'QATAR', 'BOSNIA AND HERZEGOVINA', 'CROATIA', 'SERBIA', 'MALAYSIA', 'MEXICO', 'BULGARIA', 'BRAZIL', 'SWEDEN', 'FRANCE', 'POLAND', 'AFRICA', 'ISRAEL', 'GREECE', 'CYPRUS', 'SOUTH AFRICA', 'ROMANIA', 'UNITED ARAB EMIRATES', 'NETHERLANDS', 'ARGENTINA', 'RUSSIA', 'EGYPT', 'IRELAND', 'SAUDI ARABIA', 'NEW ZEALAND', 'INDIA', 'CHILE', 'URUGUAY', 'ICELAND', 'COLUMBIA', 'TURKEY', 'OTHERS']
